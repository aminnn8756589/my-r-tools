...
load_my_tools <- function(fichiers = c("smart_impute.R", "expert_outlier_handler_2026.R", "audit_df_pro.R", "expert_multilinear.R", "inspection.R", "audit_df_pro", "audit.R", "audit_pro")) {
